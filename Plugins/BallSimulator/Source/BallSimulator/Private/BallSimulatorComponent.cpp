	...
	int32 HitCount)
{
	...
	*/
	...
	if (bIsSliding)
	{
		...
		AngularVelocity = (AngularVelocity + angularDelta * BounceToRotateMultiply) * 0.5f;
	...
	else
	{
		...
		LinearVelocity += frictionImpulse * InvMass;
		LinearVelocity += normalImpulse * InvMass;
